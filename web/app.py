...
def certified_fragment_panel() -> str:
    ...
    truth_condition_obligation_items = "".join(
        (
            ...
            f'data-truth-condition-obligation-proof-index-scope="{html.escape(str(item.get("proof_index_scope", "")), quote=True)}" '
            ...
            f'data-truth-condition-obligation-sample-entrypoints="{html.escape(data_list(item.get("sample_proof_entrypoints")), quote=True)}" '
    ...
    surface_parser_items = "".join(
        (
            ...
            f'data-surface-slot-probe-count="{html.escape(str((item.get("slot_probe_examples") or {}).get("probe_count", "")) if isinstance(item.get("slot_probe_examples"), dict) else "", quote=True)}" '
