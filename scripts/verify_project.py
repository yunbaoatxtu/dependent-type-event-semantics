...
def validate_certified_fragment_manifest(manifest: dict) -> None:
    ...
    required_verified_ids = {
        ...
        "coq_independent_registered_truth_condition_instance_suite_package",
        ...
        "coq_concrete_truth_condition_provider_class_obligation_suite",
        ...
        "coq_concrete_truth_condition_independent_model_candidate_certificate",
        "coq_concrete_truth_condition_independent_model_readiness_certificate",
